...
# changed line 53 from "sk.marching_cubes" to "sk.marching_cubes_classic"
...
LOCAL_PATH = '/second_disk/ShapeNet/3DShapeNets/volumetric_data/'
SERVER_PATH = '/second_disk/ShapeNet/3DShapeNets/volumetric_data/'
